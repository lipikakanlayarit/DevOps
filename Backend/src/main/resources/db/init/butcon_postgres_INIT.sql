...
-- ========== 9) SEED DATA (with real BCrypt) =================================
-- Users (password = password123)
INSERT INTO users (email, username, password_hash, first_name, last_name, phone_number, id_card_passport, role)
VALUES
...
-- Example reserved & payments (optional for demo)
...
-- (optional) quick seat grid for demo
