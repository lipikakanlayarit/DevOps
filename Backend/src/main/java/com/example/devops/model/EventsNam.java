...
public class EventsNam {
  ...
  public Instant getStart_datetime() {
    return start_datetime;
  }

  public void setStart_datetime(Instant start_datetime) {
    this.start_datetime = start_datetime;
  }

  public Instant getEnd_datetime() {
    return end_datetime;
  }

  public void setEnd_datetime(Instant end_datetime) {
