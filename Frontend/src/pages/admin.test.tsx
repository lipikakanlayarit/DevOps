...
describe("EventPermissionPage", () => {
    ...
    describe("Data Display", () => {
        ...
        it(
            "displays events table correctly",
            async () => {
                render(<EventPermissionPage />, { wrapper: Wrapper });
                expect(await screen.findByText(/Pending Events/i)).toBeDefined();
                expect(await screen.findByText(/TITLE/i)).toBeDefined();
                expect(await screen.findByText(/CATEGORY/i)).toBeDefined();
            },
            TIMEOUT
        );
    });
