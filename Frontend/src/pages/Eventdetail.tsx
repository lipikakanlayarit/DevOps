...
export default function EventDetails() {
    ...
    useEffect(() => {
        if (!isEdit) {
            // UX: prefill เป็นสัปดาห์หน้า 19:00-22:00
            const now = new Date();
    ...
    async function handleSave() {
        ...
        const payload = {
            ...
            startDateTime: toUTC(first.startDate, first.startTime), // ✅ UTC
            endDateTime: toUTC(first.endDate, first.endTime),       // ✅ UTC
        ...
        try {
            if (isEdit) {
                ...
                const cached = { id: Number(eventId), ...payload, savedAt: new Date().toISOString() };
                localStorage.setItem(`event:${eventId}`, JSON.stringify(cached));
                localStorage.setItem(`event:last`, JSON.stringify({ id: Number(eventId), name: payload.eventName }));
                alert("อัปเดตอีเวนต์สำเร็จ!");
                navigate(`/ticketdetail/${eventId}`, { replace: true });
                return;
            }
            ...
            const newId = res?.event_id ?? res?.id;
                        ...
                        <>
                            ...
                            <div className="bg-white rounded-lg p-6 shadow-sm">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Let attendee know your event's start and end time for a
                                        smooth experience
                                    </p>
                                </div>
                            ...
                            <div className="bg-white rounded-lg p-6 shadow-sm">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Inform attendees where your event is being held and help
                                        attendees easily to find activities.
                                    </p>
                                </div>
                                        ...
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    setEventData({
                                                        ...eventData,
                                                        locationType: e.target.value as "venue" | "announced",
                                                    })
                                                }
                                                className="hidden"
                                            />
                        ...
                        To be announced
                            ...
                            <div className="bg-white rounded-lg p-6 shadow-sm">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Adding a short description helps attendees understand what
                                        your event is about.
                                    </p>
                                </div>
