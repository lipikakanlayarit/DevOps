              ...
              <div className="flex items-start gap-6 text-sm text-gray-700">
                <div className="flex items-start gap-2">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="2" className="mt-0.5">
                    <path d="M12 21s-6-5.33-6-10a6 6 0 1 1 12 0c0 4.67-6 10-6 10Z"/>
                    <circle cx="12" cy="11" r="2.5"/>
                  </svg>
                  <div>
                    <div className="font-medium">MCC HALL, 3rd Floor,</div>
                    <div className="text-gray-600">The Mall Lifestore Bangkapi</div>
                  </div>
                </div>
...
function Cell({ 
  ...
  return (
    <div className={`flex-1 p-4 ${bgColor} ${!isLast ? 'border-r-4 border-black' : ''} flex flex-col justify-center`}>
...
function TicketDemo() {
  return (
    <TicketCard
      poster="https://picsum.photos/id/1025/600/800"
      reserveId="81010012592500070567OO"
